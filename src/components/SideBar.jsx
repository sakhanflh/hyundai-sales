...
export function SideBar({onShowSidebar}){
    return(
        <>
        <div className={onShowSidebar ? "opacity-100 w-full h-[6rem] translate-y-[80px] -translate-x-3 flex absolute bg-white xl:hidden transition-all duration-500 shadow-2xl z-40 " : "w-full h-[6rem] -translate-y-[50px] -translate-x-3 flex absolute bg-white xl:hidden transition-all duration-500 shadow-2xl opacity-0 z-40"}>
